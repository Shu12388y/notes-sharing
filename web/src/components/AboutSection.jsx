...
const AboutSection = () => {
  ...
  const stats = [
    ...
    { icon: Users, value: '5000+', label: 'Students Taught', color: 'from-blue-500 to-cyan-500' },
    { icon: BookOpen, value: '50+', label: 'Courses Created', color: 'from-green-500 to-teal-500' },
  ...
  const features = [
    {
      ...
      description: 'Targeted preparation strategies designed specifically for GATE success'
    },
    {
      icon: Zap,
      title: 'Interactive Learning',
      description: 'Modern teaching methods with hands-on practice and real-time feedback'
    },
    {
      icon: Users,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            Empowering <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Dreams</span>
          </h2>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-purple-100 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  With over a decade of experience in computer science education, I've dedicated my career to transforming the way students approach competitive examinations like GATE. My passion lies in making complex concepts accessible and engaging.
                </p>
                
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  As an Academic Head specializing in Computer Science & IT, I combine theoretical knowledge with practical insights to create comprehensive learning experiences that go beyond traditional teaching methods.
                </p>

                <p className="text-lg text-gray-700 leading-relaxed">
                  My commitment extends beyond exam preparation – I aim to build strong foundations that serve students throughout their professional careers in computer science.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={`transform transition-all duration-1000 delay-600 ${
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-purple-100 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-bold text-center text-gray-900 mb-12">Achievement Highlights</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {stats.map((stat, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${stat.color} rounded-2xl mb-4 group-hover:rotate-12 transition-transform duration-300`}>
